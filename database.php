    ...
    $tables = [
        ...
        'users' => "
            CREATE TABLE IF NOT EXISTS users (
                ...
                risk_status ENUM('normal', 'sari', 'kirmizi') DEFAULT 'normal',
        ...
        'social_media_posts' => "
            CREATE TABLE IF NOT EXISTS social_media_posts (
                ...
                post_type ENUM('post', 'story', 'reel', 'video', 'carousel', 'live') DEFAULT 'post',
        ...
        'projects' => "
            CREATE TABLE IF NOT EXISTS projects (
                ...
                status ENUM('planlama', 'devam_ediyor', 'beklemede', 'tamamlandi', 'iptal') DEFAULT 'planlama',
                start_date DATE,
                end_date DATE,
        ...
        'contact_logs' => "
            CREATE TABLE IF NOT EXISTS contact_logs (
                ...
                contact_type ENUM('email', 'telefon', 'whatsapp', 'yuz_yuze', 'toplanti', 'diger') NOT NULL,
                subject VARCHAR(255),
                message TEXT,
                contact_date DATETIME NOT NULL,
                response_status ENUM('bekliyor', 'yanitlandi', 'takip_edilecek', 'tamamlandi') DEFAULT 'bekliyor',
                priority ENUM('dusuk', 'orta', 'yuksek', 'acil') DEFAULT 'orta',
